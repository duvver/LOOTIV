...
class OkeyTable extends EventEmitter {
  ...
  // Turkiye'de okey SAGA doner: koltuklar 0=alt, 1=sol, 2=ust, 3=sag oldugundan
  // sira 0 -> 3 -> 2 -> 1 -> 0 (azalan) yonunde ilerler, yani saga.
  ...
  async sit(user, seatIndex) {
    ...
    // Test kolayligi: bakiye kontrolu devre disi (botlarla oynanan deneme masasi).
    // Uretimde asagidaki satiri geri acabilirsiniz:
